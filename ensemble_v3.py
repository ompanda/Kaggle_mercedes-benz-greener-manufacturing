...
model_r2_score = r2_score(y_train, stacked_pipeline.predict(finaltrainset) * 0.2855 + model.predict(dtrain) * 0.7145)
...
sub.to_csv(base_output_path+'ensemble_v3_r2_score_{}.csv'.format(model_r2_score), index=False)
