...
prediction1 = scores1.mean()
prediction2 = scores2.mean()

print('=====================')

print('Final Mean Squared Error %f' % prediction1)

print('=====================')

print('=====================')

print('Final R^2 %f' % prediction2)
...
output.to_csv(base_output_path+'keras-v2-r2-{}.csv'.format(test_r2_score), index=False)