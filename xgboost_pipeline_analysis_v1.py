...
submission.to_csv(base_output_path+'submission.csv', index=False)
...
submission = pd.DataFrame({'id': pid, 'y': pred})
submission.to_csv(base_output_path+'submission_ov.csv', index=False)

# Plotting
import matplotlib.pyplot as plt
plt.rcParams['figure.figsize'] = (15.0, 15.0)
xgb.plot_importance(model)
plt.savefig(base_output_path+'feature_importance.png') #will be complex w/ all transformations and data obfuscation